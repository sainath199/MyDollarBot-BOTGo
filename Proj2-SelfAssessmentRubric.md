...
|3  | Test cases exist | 111 test cases with coverage > 85% for each file -> https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml |

|3	| Use of code coverage	| https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml |

|3	| Other automated analysis tools | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml, Cron Jobs Exist |
...
|Y| 1.1 Does your website and documentation provide a clear, high-level overview of your software? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md |

|Y| 1.2: Does your website and documentation clearly describe the type of user who should use your software?   | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md |

|N| 1.3: Do you publish case studies to show how your software has been used by yourself and others? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/docs/history.md |
...
|Y| 4.3: If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md |

|Y| 4.4: Do you provide a comprehensive guide to all your software’s commands, functions and options?  | https://github.com/sainath199/MyDollarBot-BOTGo |
...
|Y| 4.8: Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation? | https://github.com/sainath199/MyDollarBot-BOTGo/releases |
...
|Y| 5.4: Are e-mails to your support e-mail address received by more than one person? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/CONTRIBUTING.md, two email ids present |

|Y| 5.5: Does your project have a ticketing system to manage bug reports and feature requests? | https://github.com/sainath199/MyDollarBot-BOTGo/actions |
...
|Y| 6.2: Does your software use an accepted coding standard or convention?  | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml |

|Y| 7.1: Does your software allow data to be imported and exported using open data formats? e.g. GIF, SVG, HTML, XML, tar, zip, CSV, JSON, NetCDF, or domain specific ones e.g. GIF, SVG, HTML, XML, tar, zip, CSV, JSON, NetCDF, or domain specific ones | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/code/extract.py |
...
|Y| 10.1: Is your source code stored in a repository under revision control?  | github and github releases - https://github.com/sainath199/MyDollarBot-BOTGo/releases |

|Y| 10.2: Is each source code release a snapshot of the repository? | https://github.com/sainath199/MyDollarBot-BOTGo/releases |

|Y| 10.3: Are releases tagged in the repository? | https://github.com/sainath199/MyDollarBot-BOTGo/tags |

|Y| 10.4: Is there a branch of the repository that is always stable? (i.e. tests always pass, code always builds successfully) | https://github.com/sainath199/MyDollarBot-BOTGo/tree/main/ |

|Y| 10.5: Do you back-up your repository  | dev-branch and releases - https://github.com/sainath199/MyDollarBot-BOTGo/releases |

|Y| 11.1: Do you provide publicly-available instructions for building your software from the source code?   | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md |

|N| 11.2: Can you build, or package, your software using an automated tool?  ||

|Y| 11.3: Do you provide publicly-available instructions for deploying your software? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md |

|Y| 11.4: Does your documentation list all third-party dependencies? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/requirements.txt |  

|Y| 11.5: Does your documentation list the version number for all third-party dependencies? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/requirements.txt| 

|Y| 11.6: Does your software list the web address, and licences for all third-party dependencies and say whether the dependencies are mandatory or optional? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/CONTRIBUTING.md |

|Y| 11.7: Can you download dependencies using a dependency management tool or package manager?  | using PIP| 

|Y| 11.8: Do you have tests that can be run after your software has been built or deployed to show whether the build or deployment has been successful?  | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml |

|Y| 12.1: Do you have an automated test suite for your software? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml | 

|N| 12.2: Do you have a framework to periodically (e.g. nightly) run your tests on the latest version of the source code?  | |

|Y| 12.3: Do you use continuous integration, automatically running tests whenever changes are made to your source code? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml | 

|Y| 12.4: Are your test results publicly visible?  | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/.github/workflows/test.yml |

|Y| 12.5: Are all manually-run tests documented? | https://github.com/sainath199/MyDollarBot-BOTGo/tree/main/docs |
...
|Y| 13.3: Do you provide success stories on your website?   | Video in readme - https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md | 

|Y| 13.4: Do you list your important partners and collaborators on your website?   | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/README.md | 
...
|Y| 13.8: If your software is developed as an open source project (and, not just a project developing open source software), do you have a governance model? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/CONTRIBUTING.md | 
...
|Y| 14.2: Do you have a contributions policy? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/CONTRIBUTING.md | 

|Y| 14.3: Is your contributions' policy publicly available?  | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/CONTRIBUTING.md | 

|N| 14.4: Do contributors keep the copyright/IP of their contributions?  || 

|Y| 15.1: Does your website and documentation clearly state the copyright owners of your software and documentation? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/LICENSE | 

|N| 15.2: Does each of your source code files include a copyright statement?   || 

|Y| 15.3: Does your website and documentation clearly state the licence of your software?   | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/LICENSE | 

|Y| 15.4: Is your software released under an open source licence? | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/LICENSE| 

|Y| 15.5: Is your software released under an OSI-approved open-source licence?  | https://github.com/sainath199/MyDollarBot-BOTGo/blob/main/LICENSE |
